...
const Model = forwardRef((_props, ref) => {
  const { scene } = useGLTF('/assets/sf23/sf23.glb');
  ...
  return <primitive object={scene} ref={modelRef} position={[STARTING_X_POSITION, STARTING_Y_POSITION, 0]} scale={0.8} />;
});
